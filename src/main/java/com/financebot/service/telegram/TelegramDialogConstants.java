...
public final class TelegramDialogConstants {
    ...
    public static final String FLOW_ACCOUNT_EDIT = "ACCOUNT_EDIT";
    public static final String FLOW_ACCOUNT_DELETE = "ACCOUNT_DELETE";
    ...
    public static final String STEP_LIMIT = "LIMIT";
    public static final String STEP_USED = "USED";
    public static final String STEP_CUTOFF = "CUTOFF";
    public static final String STEP_PAYMENT_DUE = "PAYMENT_DUE";
